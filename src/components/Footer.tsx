const Footer = () => {   
    return (
        <footer className="footer footer-center py-5 relative border-t border-t-gray-500/80 text-base-content rounded mt-8 bg-cover bg-no-repeat bg-center bg-fixed"
        style={{
            backgroundImage: `linear-gradient(to bottom, rgba(19, 17, 21, 0.2), rgba(13, 17, 21, 0.9)), url('./src/assets/footer_bg.svg')`,
        }}>
            <p className="py-4">
